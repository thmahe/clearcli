...
class ExpressCliHelpFormatter(argparse.RawTextHelpFormatter):
    ...
    def _format_action(self, action):
        ...
        if type(action) == argparse._SubParsersAction._ChoicesPseudoAction:
            ...
            return super(ExpressCliHelpFormatter, self)._format_action(action)
...
class ExpressCli:
    ...
    def __init__(self, descriptor: dict, prog: str = os.path.basename(sys.argv[0]), description=""):
        ...
        self._cli = argparse.ArgumentParser(prog=prog, formatter_class=ExpressCliHelpFormatter)
    ...
    def big_bang(self):
        ...
        callable_ = args.get('_EXPRESSCLI_CALLABLE')(**args)
    ...
    def _from_dict_descriptor(self, descriptor, cli: argparse.ArgumentParser, depth=0):
        if isinstance(descriptor, dict):
                ...
                for command_name, sub_descriptor in descriptor.items():
                    try:
                        ...
                        parser = sub_parser.add_parser(command_name,
                                                       formatter_class=ExpressCliHelpFormatter,
            ...
            raise TypeError('ExpressCli sub-descriptor must be of type <dict>')
